...
def main():
    ...
    # verrattavissa itse katsottuun/kirjattuun listaan (esim.
    # "25, 49, 1:03, ...") - nopein tapa tarkistaa loytyivatko KAIKKI
    # heitot, tuliko YLIMAARAISIA (ei-toivottuja) havaintoja, tai
